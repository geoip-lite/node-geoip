	...
	do {
		...
		if (floor <= ip && ceil >= ip) {
			...
			if (recordSize === RECORD_SIZE) {
				...
				geodata.timezone = locBuffer.toString('utf8', (locId * locRecordSize) + 10, (locId * locRecordSize) + 34).replace(/\u0000.*/, '');
				geodata.city = locBuffer.toString('utf8', (locId * locRecordSize) + 34, (locId * locRecordSize) + locRecordSize).replace(/\u0000.*/, '');
			}
